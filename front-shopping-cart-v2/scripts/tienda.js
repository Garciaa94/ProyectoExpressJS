...
function addToCartClicked(event) {
  ...
  addItemToShoppingCart(itemTitle, itemPrice, itemStock, itemImage, itemId);
}

function addItemToShoppingCart(itemTitle, itemPrice, itemStock, itemImage, itemId) {
  ...
  const shoppingCartRow = document.createElement('div'); // Contenido debajo de Carrito
...
function updateShoppingCartTotal() {
  ...
  shoppingCartItems.forEach((shoppingCartItem) => {
    ...
    //if(num <shoppingCartItemQuantity)
  ...
  shoppingCartTotal.innerHTML = `${total.toFixed(2)}$`;  // MT
}
